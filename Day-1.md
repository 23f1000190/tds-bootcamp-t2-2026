...
--- Before Day-1 ---
I already knew Python, Linux
--- 

## Day-1 Checklist

- [x] I can open a Linux terminal and recognize the shell prompt (`spk51623@Magha26:~$`)
...
How to navigate through the things, good refresher on python/linux/github

--- Feedback (Suggestions for the TDS Team) ---
Nothing in particular, i think TAs conducted the sessions well.
